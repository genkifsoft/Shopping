<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST')
    {
        ...
        if (postInput('email') == '')
        {
            ...
            if (postInput('email') != $admin['email'])
            {
...
<?php require_once __DIR__."/../../layouts/header.php"; ?>
   ...
   <form enctype="multipart/form-data" class="form-horizontal" action="" method="POST">
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="name" placeholder="Họ và tên" value="<?php echo isset($data['name']) ? $data['name'] : $admin['name'] ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input type="text" class="form-control" name="address" placeholder="Quận 1 - Hồ Chí Minh" value="<?php echo isset($data['address']) ? $data['address'] : $admin['address'] ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <input class="form-control" type="email" name="email" placeholder="quy.dang@seldatinc.com" value="<?php echo isset($data['email']) ? $data['email'] : $admin['email'] ?>">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-3">
                <input class="form-control" type="number" name="phone" placeholder="0964944719" value="<?php echo isset($data['phone']) ? $data['phone'] : $admin['phone'] ?>">
        ...
        <div class="form-group">
                ...
                <div class="col-sm-8">
                    <select name="level" class="form-control col-sm-2">
                        ...
                        <option value="0" <?php echo isset($data['level']) && $data['level'] == 0 ? 'selected' : ($admin['level'] == 0 ? 'selected' : '') ?>>CTV</option>
                        <option value="1" <?php echo isset($data['level']) && $data['level'] == 1 ? 'selected' : ($admin['level'] == 1 ? 'selected' : '') ?>>ADMIN</option>
                    </select>
